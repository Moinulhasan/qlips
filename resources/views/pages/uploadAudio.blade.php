                    ...
                    <div class="sidecard-content-wrapper p-4 mb-5">
                        ...
                        <div class="side-card-body">
                            ...
                            <div class="drag-area">
                                ...
                                <button class="custom-file-upload-btn mt-3" id="browsButton">Browse Files</button>
                                <input type="file" name="audio" id="browsInput" hidden accept=".mp3,audio/*" />
                            </div>
                            @if ($errors->has('audio'))
                                <div class="error text-danger" id="error">
                                    <p>{{ $errors->first('audio') }}</p>
                                </div>
                            @endif
                            <div id="preview mt-3">
                            </div>
