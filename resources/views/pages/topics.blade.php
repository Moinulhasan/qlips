                    ...
                    @if(isset($data))
                        @foreach($data as $item)
                            <div class="single-table-row border-bottom py-3 px-3">
                                <div class="row align-items-center">
                                    <div class="col-md-2"><img src="{{asset('/storage/'.$item->thumbnail)}}" alt=""
                                                               class="table-content-icon "></div>
                                    <div class="col-md-5"><p class="single-table-row-item-name">{{$item->name}}</p>
                                    </div>
                                    <div class="col-md-3">
                                        <div
                                            ...
                                            <div class="tool-tip-wrapper">
                                                <div class="tooltip-content-wrapper">
                                                    ...
                                                    <div class="tooltip-item">
                                                        <form action="{{asset(route('topic.status.update',['id'=>$item->id,'status'=>'Active']))}}" method="post">
                                                           @csrf
                                                            @method('post')
                                                    ...
                                                    <div class="tooltip-item">
                                                        <form action="{{asset(route('topic.status.update',['id'=>$item->id,'status'=>'Hide']))}}" method="post">
                                                            @csrf
                                                            @method('post')
